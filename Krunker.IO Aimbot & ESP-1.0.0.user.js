...
function playStartupAudio() {
    const audio = new Audio('https://github.com/trojaninfect/mp3-hosting/raw/refs/heads/main/castle_client_staff_team_audio.wav');
    audio.volume = 0.5;

    // Try to play audio, catch error if autoplay blocked
    audio.play().catch(err => {
        console.log('Audio play was blocked:', err);

        // Optionally: wait for user interaction to play
...
// Call this function when the DOM is fully loaded and you want to play the sound
window.addEventListener('load', playStartupAudio);
...
<br>
<h2 style="font-family: Calibri, sans-serif; color: purple; font-size: 28px;">
  welcome to the
  <u>
    <b style="font-family: Calibri, sans-serif; cursor:pointer; color: purple;">
      ! Castle client !
    </b>
  </u>
</h2>
<br>
    	...
    	<div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 5px;">
    		<div class="btn" onclick="window.open('https://ammo.lol/pills/', '_blank')">Website</div>
    		<div class="btn" onclick="window.open('https://www.instagram.com/taking.cyanide/', '_blank')">Instagram</div>
    		<div class="btn" onclick="window.open('https://twitter.com/im_conflictedd', '_blank')">Twitter</div>
    		<div class="btn" onclick="window.open('https://github.com/trojaninfect', '_blank')">Github</div>
    	</div>
